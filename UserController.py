...
def stringGenerator(size=8, chars=string.ascii_letters + string.digits):
    """
        Generates random string
        @param size: length of random string, default 8
        @param chars: chars used in random string, default letters and digits
    """
